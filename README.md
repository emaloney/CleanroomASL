...
- The [`master`](https://github.com/emaloney/CleanroomASL) branch uses **Swift 3.0**, requiring Xcode 8.0
- The [`xcode-8.1`](https://github.com/emaloney/CleanroomASL/tree/xcode-8.1) branch uses **Swift 3.0.1**, requiring Xcode 8.1
...
[`xcode-8.1`](https://github.com/emaloney/CleanroomASL/tree/xcode-8.1)|[![Build status: xcode-8.1 branch](https://travis-ci.org/emaloney/CleanroomASL.svg?branch=xcode-8.1)](https://travis-ci.org/emaloney/CleanroomASL)
[`xcode-8.2`](https://github.com/emaloney/CleanroomASL/tree/xcode-8.2)|[![Build status: xcode-8.2 branch](https://travis-ci.org/emaloney/CleanroomASL.svg?branch=xcode-8.2)](https://travis-ci.org/emaloney/CleanroomASL)
...
CleanroomASL is distributed under [the MIT license](https://github.com/emaloney/CleanroomASL/blob/xcode-8.2/LICENSE).
...
Finally, you’ll need to [integrate CleanroomASL into your project](https://github.com/emaloney/CleanroomASL/blob/xcode-8.2/INTEGRATION.md) in order to use [the API](https://rawgit.com/emaloney/CleanroomASL/xcode-8.2/Documentation/API/index.html) it provides.
...
See [the Integration document](https://github.com/emaloney/CleanroomASL/blob/xcode-8.2/INTEGRATION.md) for additional details on integrating CleanroomASL into your project.
...
For detailed information on using CleanroomASL, [API documentation](https://rawgit.com/emaloney/CleanroomASL/xcode-8.2/Documentation/API/index.html) is available.
...
[API documentation for CleanroomASL](https://rawgit.com/emaloney/CleanroomASL/xcode-8.2/Documentation/API/index.html) is generated using [Realm](http://realm.io)’s [jazzy](https://github.com/realm/jazzy/) project, maintained by [JP Simard](https://github.com/jpsim) and [Samuel E. Giddins](https://github.com/segiddins).
